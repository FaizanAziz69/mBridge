    ...
    const IMAGES_WITH_DESCRIPTIONS = [
        {
            ...
            description: "Follow these simple steps to permanently delete your account and all associated data",
            steps: [
                {
        ...
        <div className="flex flex-col gap-16">
            ...
            <section className="py-20 px-8 mt-20">
                <div className="max-w-6xl mx-auto space-y-12">
                    {IMAGES_WITH_DESCRIPTIONS.map(({ src, alt, title, description,steps }, index) => (
                        <div
                            key={src}
                        ...
                        >
                            ...
                            <div className="lg:w-1/2 text-center lg:text-left">
                                <Typography
                                    variant="h4"
                                    className="mb-6 text-black font-bold" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}              >
                                    {title}
                                </Typography>
                                ...
                                <ul className=" list-decimal ml-4 mt-1">
                                    {
                                        steps.map((items,i)=>{
                                            return <li key={i} className="text-gray-700">{items.steps}</li>
                                        })
                                    }
                                </ul>
                            </div>
